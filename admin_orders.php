...
if(isset($_POST['update_order'])){
   ...
   mysqli_query($conn, "UPDATE `orders` SET `payement_status` = '$update_payement' WHERE id = '$order_id'") or die('query failed');
   $message[] = 'payement status has been updated!';
}
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <select name="update_payement">
               <option disabled selected><?php echo $fetch_orders["payement_status"]; ?></option>
